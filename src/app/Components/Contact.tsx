    ...
    return (
      <section className=" py-20" id="contact">
        <div className="max-w-5xl mx-auto">
          ...
          <form className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="w-full p-4 bg-[#0f2a3f] rounded-lg "
              />
              <input
                type="email"
          ...
          {/* Social Links */}
          <div className=" mt-10 flex justify-center space-x-20 text-center ">
            <a href="https://github.com/Hammad8288?tab=repositories" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/in/hammad-ahmed-7aa73118a/" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.facebook.com/hammad.ahmed.32" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://wa.me/923323446979" target="_blank" rel="noopener noreferrer">
